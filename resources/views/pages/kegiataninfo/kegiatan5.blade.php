                            ...
                            <div class="card-body">
                                <div class="alert alert-primary alert-dismissible fade show" role="alert">
                                    <p class="mb-0" style="color:black">
                                        Halaman ini menampilkan informasi kegiatan <H9 style="font-weight: bold;">Kejuaraan/Kompetensi/Perlombaan</H9>. Berikut rincian tingkat kegiatan tersebut dapat di lihat dibawah ini.
                                    </p>
                                </div>
                                ...
                                <h7 class="text">
                                    D. KEJUARAAN / KOMPETENSI / PERLOMBAAN
                                </h7><br>
                                ...
                                <h8 class="text">
                                    <i class="fa fa-arrow-circle-right"></i> NASIONAL UMUM
                                </h8><br>
                                <h8 class="text">
                                    <i class="fa fa-arrow-circle-right"></i> PKM/PIMNAS
                                </h8><br>
                                <h8 class="text">
