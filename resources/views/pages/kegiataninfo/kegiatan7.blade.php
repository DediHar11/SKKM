                            ...
                            <div class="card-body">
                                <div class="alert alert-primary alert-dismissible fade show" role="alert">
                                    <p class="mb-0" style="color:black">
                                        Halaman ini menampilkan informasi kegiatan <H9 style="font-weight: bold;">Penghargaan Akademik & Penghargaan Non Akademik</H9>. Berikut rincian tingkat kegiatan tersebut dapat di lihat dibawah ini.
                                    </p>
                                </div>
