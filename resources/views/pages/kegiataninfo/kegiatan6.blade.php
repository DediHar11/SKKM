                            ...
                            <div class="card-body">
                                <div class="alert alert-primary alert-dismissible fade show" role="alert">
                                    <p class="mb-0" style="color:black">
                                        Halaman ini menampilkan informasi kegiatan <H9 style="font-weight: bold;">Penelitian, Pengabdian Masyarakat, Seminar, Kuliah Tamu, Pemateri dan Kegiatan Ilmiah Lainnya</H9>. Berikut rincian tingkat kegiatan tersebut dapat di lihat dibawah ini.
                                    </p>
                                </div>
                                ...
                                <h7 class="text">
                                    E. PENELITIAN, PENGABDIAN MASYARAKAT, SEMINAR, KULIAH TAMU, PEMATERI DAN KEGIATAN ILMIAH LAINNYA.
                                </h7><br>
                                ...
                                <h8 class="text">
                                    <i class="fa fa-arrow-circle-right"></i> LOKAL
                                </h8><br><br>
