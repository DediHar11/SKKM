                            ...
                            <div class="card-body">
                                <div class="alert alert-primary alert-dismissible fade show" role="alert">
                                    <p class="mb-0" style="color:black">
                                        Halaman ini menampilkan informasi kegiatan <H9 style="font-weight: bold;">Kepengurusan Organisasi Selain Organisasi Kemahasiswaan Intra</H9>. Berikut rincian tingkat kegiatan tersebut dapat di lihat dibawah ini.
                                    </p>
                                </div>
                                ...
                                <h8 class="text">
                                    <i class="fa fa-arrow-circle-right"></i> REGIONAL/PROPINSI
                                </h8><br>
                                <h8 class="text">
                                ...
                                <h8 class="text">
                                    <i class="fa fa-arrow-circle-right"></i> PENGURUS KELAS
                                </h8><br>
                                <h8 class="text">
                                    <i class="fa fa-arrow-circle-right"></i> KEGIATAN SEMPRO/ SEMHAS
                                </h8><br><br>
