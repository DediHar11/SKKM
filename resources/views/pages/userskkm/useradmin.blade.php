	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0" style="font-weight:bold;">DATA ADMIN</h2>
				</div>
			</div>
		</div>
	</div>
	<div class="content-body">
		...
		<section id="data-thumb-view" class="data-thumb-view-header">
					...
					<table class="table data-thumb-view dataTable no-footer dt-checkboxes-select" id="DataTables_Table_0" role="grid">
						<thead>
							<tr role="row">
								...
								<!-- <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 49.9px;" aria-label="ACTION: activate to sort column ascending">ACTION</th> -->
							</tr>
						</thead>
						<tbody>
			...
			<div class="add-new-data-sidebar">
				<form action="{{route('dataadmin.storeadmin')}}" method="post">
					{{csrf_field()}}
						...
						<div class="data-items pb-3 ps ps--active-y">
							<div class="data-fields px-2">
								<div class="row">
									...
									<div class="col-sm-12 data-field-col">
										<label for="data-name"><span style="color:red; font-size:16px;">Password default :</span>
											<p style="font-weight:bold;font-size:17px;">"12345678"</p>
										</label>
									</div>
									<div class="add-data-footer d-flex justify-content-around px-3">
										...
										<div class="cancel-data-btn ml-2">
											<a href="{{route('dataadmin.index')}}" class="btn btn-outline-danger waves-effect waves-light">Cancel</a>
										</div>
									</div>
								</div>
							</div>
