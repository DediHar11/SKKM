				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title" style="font-weight:bold;color:teal;"><i class="feather icon-award"></i>SELURUH KEGIATAN MAHASISWA</h4>
						</div>
						<div class="card-content">
							<div class="card-body card-dashboard">
								<div class="alert alert-primary alert-dismissible fade show" role="alert">
									<p class="card-text" style="color:black">
										Berikut ini adalah <h9 class="text" style="font-weight:bold;">Seluruh Kegiatan Mahasiswa</h9>
									</p>
								</div>
													...
													<tbody>
														...
														<tr role="row" class="odd">
															...
															<td>
																...
																<button class="btn-sm btn-danger mr-1 mb-1 waves-effect waves-light">Belum Verifikasi</button>
																@else
