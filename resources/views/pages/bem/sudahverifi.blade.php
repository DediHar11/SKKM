				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title" style="font-weight:bold;color:teal;"><i class="feather icon-award"></i>VERIFIKASI POIN TERVERIFIKASI</h4>
						</div>
						<div class="card-content">
							<div class="card-body card-dashboard">
								<div class="alert alert-primary alert-dismissible fade show" role="alert">
									<p class="card-text" style="color:black">
                                        Berikut ini adalah tabel poin mahasiswa yang <h9 class="text" style="font-weight:bold ;">sudah di verifikasi</h9>
									</p>
								</div>
