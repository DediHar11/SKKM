...
<head>
    ...
    <title>Halaman Register SKKM Poliwangi</title>
...
<body class="vertical-layout vertical-menu-modern 1-column  navbar-floating footer-static bg-full-screen-image  menu-collapsed blank-page blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
    ...
    <script>
        var clicked_c = 0;
        $(".password-satu").click(function(e) {
            e.preventDefault();

            $(this).toggleClass("password-satu");
            if (clicked_c == 0) {
        ...
        var clicked_c = 0;
        $(".password-dua").click(function(e) {
            e.preventDefault();

            $(this).toggleClass("password-dua");
            if (clicked_c == 0) {
                $(this).html('<i class="feather icon-eye"></i>');
